...
5. 右下角的Line Col显示的是当前输入光标所在的行数和列数，以方便在代码出错的时候查看对应的位置。

6. 这个编辑器里有内置很多电脑键盘的快捷键的组合，分别对应多种不同的功能。
...
| ctrl + q        | 关闭编辑器                                   |
| ctrl + r        | 运行当前的代码                               |
| ctrl + 鼠标滚轮 | 调节字体大小，往上滚字体变大，往下滚字体变小 |
| ctrl + b        | 播放选中的musicpy代码                        |
| ctrl + g        | 可视化播放选中的musicpy代码                  |
